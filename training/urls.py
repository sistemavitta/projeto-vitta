...
from training.views import TreinosListView,TreinarView, TreinamentoView,FinalizarView , TrocarFichaView , CancelarTreinamentoView
...
urlpatterns = patterns('training.views',
    ...
    url(r'treinos/cancelar/$', CancelarTreinamentoView.as_view(), name='cancelar-treinamento'),
